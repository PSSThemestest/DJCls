...
from .models import Categ, Product, Message, Comment, Trade
...
class CommentSerializer(serializers.ModelSerializer):
    class Meta:
        model = Comment
        fields = ('id', 'text', 'product_id', 'sender')
...
class ProductSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        fields = ('id', 'title', 'body', 'date', 'category', 'author', 'image', 'comments', 'price', 'location', 'featured')

class ProductSimpleSerializer(serializers.ModelSerializer):
    class Meta:
        model = Product
        fields = ('id', 'title', 'date', 'price', 'image', 'featured')
...
class TradeSerializer(serializers.ModelSerializer):
    class Meta:
        model = Trade
        fields = ('id', 'desired_product', 'offered_product', 'offered_amount')
